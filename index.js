...
console.log(heroAction("spider man", "web slinging", "queens"))
...
let super1 = "Cat Woman";
let sPower = "stealth"
let place = "city"

function action(super1,sPower,place){

return super1 + "uses" + sPower + "to roam the" + place;
}



let first = action("cat woman" , "stealth" , "city")
console.log(action("cat woman" , "stealth" , "city"))
...
function actionTwo(super2,sPower2,place2){
return super2 + "goes out to" + sPower2 + "to spectate" + place2;
}

let second = actionTo("iron man" , "stealth" , "city")
console.log(action("cat woman" , "stealth" , "city"))
